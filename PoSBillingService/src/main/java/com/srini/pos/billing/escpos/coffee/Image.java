...
import com.srini.pos.billing.escpos.coffee.image.Bitonal;
import com.srini.pos.billing.escpos.coffee.image.BitonalThreshold;
import com.srini.pos.billing.escpos.coffee.image.EscPosImage;
import com.srini.pos.billing.escpos.coffee.image.GraphicsImageWrapper;
...
public class Image {
	public void GraphcsImageWrapper(String printerName) {
		...
		try {
			 ...
			 * determine the command set to be used on image printing and how to customize
			 * it.
			 */
			...
			escpos.writeLF(new Style().setFontSize(Style.FontSize._2, Style.FontSize._2), "GraphicsImageWrapper");
	...
	private URL getURL(String imageName) {
		...
		return getClass().getClassLoader().getResource(strPath);
	}
