package com.srini.pos.billing.escpos.coffee.barcode;
...
public class BarCode implements EscPosConst, BarCodeWrapperInterface {
	 ...
	 * <p>
	 * Human Readable Interpretation (HRI) position is the position of the text
	 * relative to the position of the bar-code.
	 * 
	 ...
	 * <p>
	 * Human Readable Interpretation (HRI) font is the font of the text printed with
	 * bar-code.
	 * 
	 * @see #setHRIFont(escpos.barcode.BarCode.BarCodeHRIFont)
	 */
	public enum BarCodeHRIFont {
		Font_A_Default(48), Font_B(49), Font_C(50);
		public int value;
	 ...
	 * ASCII GS w n
	 * 
	 * @param width  codes for widths of the module, the width of module depends of
	 *               printer model.
	 * @param height height of a bar code in dots.
	 * @return this object.
	 * @throws IllegalArgumentException when this condition is not true: 2 ≤ width
	 *                                  ≤ 6, 68 ≤ width ≤ 76
	 * @throws IllegalArgumentException when this condition is not true: 1 ≤
	 *                                  height ≤ 255
	 * @see #getBytes(java.lang.String)
	 */
