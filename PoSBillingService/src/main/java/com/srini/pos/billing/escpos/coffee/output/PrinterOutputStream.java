...
package com.srini.pos.billing.escpos.coffee.output;
...
public class PrinterOutputStream extends PipedOutputStream {
	 ...
	 * <p>
	 * Create one print based on print service. Start print job linked (this) output
	 * stream.
	 * 
	...
	/**
	 * Get default system printer. This call is slow, try to use it only once and
	 * reuse the PrintService variable.
	 * 
