...
public class PDF417 implements EscPosConst, BarCodeWrapperInterface {
	...
	public enum PDF417Option {
		Standard_Default(0), Truncated(1);
		public int value;
	 ...
	 * @return this object
	 * @throws IllegalArgumentException when numberOfRows is not between 3 and 90
	 *                                  and not equal 0
	 * @see #getBytes(java.lang.String)
	 */
...
//    }
	 ...
	 * <p>
	 * 
	 * Function 068: Sets the row height for PDF417 to [n × (the width of the
	 * module)].
	 * <p>
